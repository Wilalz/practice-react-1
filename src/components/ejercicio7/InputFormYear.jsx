...
export const InputFormYear = ({msg, min, max}) => {
...
// 5. el imput usa el manejador del evento
    return (
        <>
            ...
            {validateYear ? "" : <span className={styles.error_msg}>{msg}</span>}
            {validateYear ? "" : <span className={styles.error_msg}>There is an error in this field</span>}
        </>
